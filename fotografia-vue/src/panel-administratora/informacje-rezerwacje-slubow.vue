      ...
      <div class="home-content">
        <div class="home-columns">
          <div class="home-left">
            ...
            <p>Sesja narzeczeńska: {{ formattedSessionNarzecienska }}</p>
          </div>
          <div class="home-right">
            <p>Sesja w innym dniu: {{ formattedSessionInnyDzien }}</p>
            <p>Czas pracy fotografa: {{ rezerwacja.czas_pracy_fotografa }}</p>
...
export default {
  computed: {
    ...
    formattedSessionInnyDzien() {
      return this.rezerwacja.sesja_w_innym_dniu ? 'Tak' : 'Nie';
    },
    formattedSessionNarzecienska() {
      return this.rezerwacja.sesja_narzecienska ? 'Tak' : 'Nie';
    }
  },
  components: {
    AdminHeader,
  ...
  methods: {
      ...
      if (localStorage.getItem('isLoggedIn') === 'true') {
        ...
        if (this.rezerwacja && this.rezerwacja.id) {
          ...
          if (this.userRole === 'admin') {
            ...
            router.push('/informacje-rezerwacje-slubow/' + this.rezerwacja.id);
          } else {
    ...
    fetchRezerwacjaData() {
      ...
      axios.get(`http://46.41.148.115/api/informacje-rezerwacje-slubow/${rezerwacjaId}`)
        .then(response => {
