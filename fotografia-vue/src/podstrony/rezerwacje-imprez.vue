                    ...
                    <div class="reservation-left">
                        <div class="reservation-left-content">
                            ...
                            <div class="reservation-buttons">
                                ...
                                <router-link to="/rezerwacje-imprez"><button class="reservation-btn active">Urodziny / Chrzciny / Roczek / Komunia</button></router-link>
                    ...
                    <form class="reservation-right" @submit="sendForm">
                        <div class="reservation-right-content">
                            ...
                            <div class="input-flex">
                                ...
                                <input type="text" v-model="formData.miejsceWydarzenia" placeholder="Wprowadź miejsce imprezy" required>
                            </div>
                            <div class="checkbox-flex">
                                ...
                                <div class="checkbox-left">
                                    <div class="checkbox-text">
                                        <p>Sesja z rodziną / znajomymi</p>
                                    </div>
                                    <div class="checkbox-content">
                                        <input type="radio" name="sesja_z_rodzina" value="true" v-model="formData.sesjaZRodzina" />
                                        <p>Tak</p>
                                        <input type="radio" name="sesja_z_rodzina" value="false" v-model="formData.sesjaZRodzina" />
                                        <p>Nie</p>
                                    </div>
                                </div>
                            </div>
    ...
    methods: {
      ...
      async sendForm(event) {
        ...
        const reservationData = {
          ...
          sesja_z_rodzina: this.formData.sesjaZRodzina === "true",
        ...
        try {
          const response = await axios.post('http://46.41.148.115/api/rezerwacje-imprez', reservationData);
      ...
      async fetchDataFromAPI() {
        try {
          const response = await axios.get('http://46.41.148.115/api/kalendarz-imprez');
