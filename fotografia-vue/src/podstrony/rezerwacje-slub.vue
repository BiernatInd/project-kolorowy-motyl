                    ...
                    <div class="reservation-left">
                        <div class="reservation-left-content">
                            ...
                            <div class="reservation-buttons">
                                <router-link to="/rezerwacje-slub"><button class="reservation-btn active">Ślub</button></router-link>
                                <router-link to="/rezerwacje-imprez"><button class="reservation-btn">Urodziny / Chrzciny / Roczek / Komunia</button></router-link>
                                <router-link to="/rezerwacje-biznesowe"><button class="reservation-btn">Sesje indywidualne / Biznesowe / Inne</button></router-link>
                            </div>
                        </div>
                    </div>
                    <form class="reservation-right" @submit="sendForm">
                        <div class="reservation-right-content">
                            ...
                            <div class="input-flex">
                                <input type="text" v-model="formData.imie" placeholder="Wprowadź imię">
                                <input type="text" v-model="formData.nazwisko" placeholder="Wprowadź nazwisko">
                            </div>
                            <div class="input-flex">
                                <input type="email" v-model="formData.email" placeholder="Wprowadź E-mail">
                                <input type="number" v-model="formData.numerTelefonu" placeholder="Wprowadź numer telefonu">
                            </div>
                            <div class="input-flex">
                                ...
                                <input type="text" v-model="formData.miejsceWydarzenia" placeholder="Wprowadź miejsce ślubu">
                            </div>
                            <div class="checkbox-flex">
                                ...
                                <div class="checkbox-left">
                                    <div class="checkbox-text">
                                        <p>Sesja narzecieńska</p>
                                    </div>
                                    <div class="checkbox-content">
                                        <input type="radio" name="sesja_narzecienska" value="true" v-model="formData.sesjaNarzecienska" />
                                        <p>Tak</p>
                                        <input type="radio" name="sesja_narzecienska" value="false" v-model="formData.sesjaNarzecienska" />
                                        <p>Nie</p>
                                    </div>
                                </div>
                                <div class="checkbox-left">
                                    <div class="checkbox-text">
                                        <p>Sesja w innym dniu</p>
                                    </div>
                                    <div class="checkbox-content">
                                        <input type="radio" name="sesja_w_innym_dniu" value="true" v-model="formData.sesjaWInnymDniu" />
                                        <p>Tak</p>
                                        <input type="radio" name="sesja_w_innym_dniu" value="false" v-model="formData.sesjaWInnymDniu" />
                                        <p>Nie</p>
                                    </div>
                                </div>
                                <div class="checkbox-left">
                                    <div class="checkbox-text">
                                        <p>Czas pracy fotografa</p>
                                    </div>
                                    <div class="checkbox-content">
                                        <input type="radio" name="czas_pracy_fotografa" value="Do 19:00" v-model="formData.czasPracyFotografa" />
                                        <p>Do 19:00</p>
                                        <input type="radio" name="czas_pracy_fotografa" value="Do 23:00" v-model="formData.czasPracyFotografa" />
                                        <p>Do 23:00</p>
                                        <input type="radio" name="czas_pracy_fotografa" value="Całą noc" v-model="formData.czasPracyFotografa" />
                                        <p>Całą noc</p>
                                    </div>
                                </div>
                            </div>
    ...
    methods: {
      ...
      async sendForm(event) {
        ...
        const reservationData = {
          ...
          sesja_narzecienska: this.formData.sesjaNarzecienska === "true",
          sesja_w_innym_dniu: this.formData.sesjaWInnymDniu === "true",
          czas_pracy_fotografa: this.formData.czasPracyFotografa,
        ...
        try {
          const response = await axios.post('http://46.41.148.115/api/rezerwacje-slubow', reservationData);
      ...
      async fetchDataFromAPI() {
        try {
          const response = await axios.get('http://46.41.148.115/api/kalendarz-slubow');
