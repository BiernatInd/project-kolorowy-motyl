    ...
    <div class="home">
        <div class="home-content">
            <div class="home-heading">
                ...
                <p>Właścicielem strony internetowej fotografia-kolorowy-motyl.pl jest firma (nazwa firmy), która jest administratorem Twoich danych osobowych.</p>
                <p>Niniejsza Polityka prywatności określa, w jaki sposób przetwarzamy informacje gromadzone na stronie fotografia-kolorowy-motyl.pl, a także wyjaśnia powody, dla których musimy gromadzić określone dane o użytkowniku.</p>
                <p>Dlatego przed rozpoczęciem korzystania ze strony fotografia-kolorowy-motyk zapoznaj się z niniejszą Polityką Prywatności.</p>
                ...
                <p>Jeżeli chcesz się z nami skontaktować, aby uzyskać więcej informacji na temat niniejszej Polityki Prywatności lub w jakiejkolwiek sprawie mającej związek z Twoimi prawami i danymi osobowymi, możesz wysłać wiadomość e-mail na adres (adres e-mail).</p>
            </div>
        </div>
    </div>
    <MainFooter />
